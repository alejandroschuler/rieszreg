...
use_python_krrr(file.path(getwd(), "../rieszboost/.venv/bin/python"))
...
::: {.callout-warning title="Falkon limitation"}
...
`krrr` exercises a [TSM1 numerical-parity test](https://github.com/alejandroschuler/RieszReg/blob/main/krrr/python/tests/test_reference_parity.py) against the [`dml-tmle`](https://github.com/alejandroschuler/dml-tmle) R reference at tolerance 1e-8.
