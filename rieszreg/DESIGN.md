...
- **Reference parity**: cross-check vs prior implementations (rieszboost vs Lee–Schuler reference; krrr vs dml-tmle at 1e-8). Land a `_compare_with_reference.py` script under `examples/<reference>/` that reports Pearson/RMSE.
